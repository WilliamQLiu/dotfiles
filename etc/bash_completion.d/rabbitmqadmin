...
_rabbitmqadmin()
{
    ...
    case "${prev}" in
        list)
            COMPREPLY=( $(compgen -W 'operator_policies users vhost_limits vhosts connections exchanges bindings permissions channels parameters consumers queues policies nodes' -- ${cur}) )
            return 0
            ;;
        show)
            ...
            ;;
        declare)
            COMPREPLY=( $(compgen -W 'queue vhost operator_policy vhost_limit user exchange policy parameter permission binding' -- ${cur}) )
            return 0
            ;;
        delete)
            COMPREPLY=( $(compgen -W 'queue vhost operator_policy vhost_limit user exchange policy parameter permission binding' -- ${cur}) )
